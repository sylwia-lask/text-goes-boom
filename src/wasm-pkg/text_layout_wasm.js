 ...
 */
export function particles_from_rgba(width, height, rgba, step, alpha_threshold) {
    const ptr0 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.particles_from_rgba(width, height, ptr0, len0, step, alpha_threshold);
